...
var UserBadge = function (_Component) {
  ...
  _createClass(UserBadge, [{
    ...
    value: function render() {
      return this.props.data.map(function (learner) {
        return _react2.default.createElement(
          'span',
          { key: learner.id, className: 'col-sm-4' },
          _react2.default.createElement(
            _reactRouterDom.Link,
            { to: '/learners/' + learner.githubHandle },
            _react2.default.createElement('img', { className: 'img-responsive', src: 'LearnerImage.png' }),
            ' '
          ),
          _react2.default.createElement(
            'p',
